...
the examples directory of the IOMux distribution for an extended
example.
...
This module is part of Any-Daemon distribution version 0.11,
built on March 21, 2011. Website: F<http://perl.overmeer.net/>
